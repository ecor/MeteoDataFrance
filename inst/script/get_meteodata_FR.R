...
oldsmetdir   <- '/home/ecor/Dropbox/R-packages/MeteoDataFrance/inst/smet_mobygis' 
###'/var/snowscripts/datiFR' 
dest         <- oldsmetdir ####'/var/snowscripts/datiFR' 
...
dates = as.character(Sys.Date()-20:1, format= "%Y%m%d") ## 20 days before the present day!
